...
namespace db {
	...
	public:
		...
		virtual std::string get_full_name() const {
			...
			return this->table_name + "." + this->name;
	...
	//class AggregationError : public std::exception {

	//	std::string message;
	//public:
	//	AggregationError(std::string message)
	//		: message() {};
	...
	//		std::string _fk_table = "",
	//		std::string _fk_atribute = "")
	//		: name(_name), table_name(_table_name), type(_type), aggregation_type(_aggregation),
	//		pk(_pk), fk(_fk), fk_table(_fk_table), fk_atribute(_fk_atribute) {};

	//	AggregatedColumn(const ColumnDescription& desc, AggregationType _aggregation)
	//		: name(desc.name), table_name(desc.table_name), type(desc.type), 
	//		aggregation_type(_aggregation), pk(desc.pk), fk(desc.fk), 
	//		fk_table(desc.fk_table), fk_atribute(desc.fk_column) {}
	...
	//		return aggregation_str(this->aggregation_type) + "(" + this->table_name + "." + this->name + ")";
